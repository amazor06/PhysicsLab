...
export default function Electricity({ onBack, simulations = [] }) {
  ...
  const emSimulations = simulations.filter(
    (sim) => sim.category === "electricity" || sim.category === "em" || sim.category === "electromagnetism"
  );
    ...
    <div className="min-h-screen flex flex-col items-center p-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white font-[Inter]">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-8">
          Interactive simulations to explore electric fields, magnetic fields, circuits, and electromagnetic phenomena.
        </p>
