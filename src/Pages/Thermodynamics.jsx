...
export default function Thermodynamics({ onBack, simulations = [] }) {
  ...
  const thermoSimulations = simulations.filter(
    (sim) => sim.category === "thermodynamics" || sim.category === "thermo"
  );
    ...
    <div className="min-h-screen flex flex-col items-center p-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white font-[Inter]">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-8">
          Interactive simulations to explore heat, energy transfer, and the laws of thermodynamics.
        </p>
