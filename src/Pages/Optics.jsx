...
export default function Optics({ onBack, simulations = [] }) {
  ...
  const opticsSimulations = simulations.filter(
    (sim) => sim.category === "optics" || sim.category === "light"
  );
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6 bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 text-white font-[Inter]">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-8">
          Interactive simulations to explore reflection, refraction, and lens behavior of light.
        </p>
